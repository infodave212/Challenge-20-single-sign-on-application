function Contact(){
    return <section class="contact section-padding pt-0" id="contact">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-12">
          ...
          <div class="mx-auto col-lg-4 col-md-6 col-12">
              <h3 class="my-4 pt-4 pt-lg-0">welcome!</h3>

              <p class="mb-1">832-846-3916</p>
            ...
            <p class="copyright-text mt-5 pt-3">Copyright &copy; 2024 David's Resume Page</p>
